package com.instargram101.chat.exception.errorCode;
...
@Getter
@AllArgsConstructor
public enum ChatErrorCode implements ErrorCodeInterface{
    Chat_Not_Found(404, "Chat Not Found"); //TODO: 여기다 커스텀 작성
